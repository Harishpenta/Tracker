...
import com.demo.tracker.utils.CustomMarkerView
    ...
    private fun subscribeToObservers() {
        ...
        viewModel.totalAvgSpeed.observe(viewLifecycleOwner, Observer {
            it?.let {
                ...
                val strTotalAvgSpeed = "${avgSpeed}km/h"
                tvAverageSpeed.text = strTotalAvgSpeed
            }
        })
        ...
        viewModel.totalDistance.observe(viewLifecycleOwner, Observer {
            it?.let {
                ...
                val strTotalDistance = "${totalDistance}km"
                tvTotalDistance.text = strTotalDistance
            }
        })
